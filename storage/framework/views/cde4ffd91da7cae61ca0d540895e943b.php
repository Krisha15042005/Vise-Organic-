                    ...
                    <?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="bg-light p-4 rounded text-center h-100">
                                <?php if(filter_var($gallery->image_path, FILTER_VALIDATE_URL)): ?>
                                    <img src="<?php echo e($gallery->image_path); ?>" alt="<?php echo e($gallery->title); ?>" class="img-fluid rounded mb-3" style="max-height: 250px; object-fit: cover; width: 100%;">
                                <?php else: ?>
                                    <div class="bg-primary text-white p-5 mb-3 rounded">
                                        <i class="fas fa-image fa-4x"></i>
                                    </div>
                                <?php endif; ?>
                                <h4 class="mb-2"><?php echo e($gallery->title); ?></h4>
                                <span class="badge bg-success"><?php echo e($gallery->category); ?></span>
                                <p class="text-muted mt-3 small"><?php echo e($gallery->created_at->format('d M Y')); ?></p>
                            </div>
                        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp">
                <div class="portfolio-inner rounded">
                    <img class="img-fluid" src="<?php echo e(asset('image/Farmer1.jpg')); ?>" alt="">
                    <div class="portfolio-text">
                        <h5 class="text-white mb-3">Happy Farmer</h5>
                        <div class="d-flex">
                            <a class="btn btn-lg-square rounded-circle mx-2" href="<?php echo e(asset('image/Farmer1.jpg')); ?>" data-lightbox="farmer" aria-label="View Image">
                                <i class="fa fa-eye"></i>
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp">
                <div class="portfolio-inner rounded">
                    <img class="img-fluid" src="<?php echo e(asset('image/Farmer2.jpg')); ?>" alt="">
                    <div class="portfolio-text">
                        <h5 class="text-white mb-3">Happy Farmer</h5>
                        <div class="d-flex">
                            <a class="btn btn-lg-square rounded-circle mx-2" href="<?php echo e(asset('image/Farmer2.jpg')); ?>" data-lightbox="farmer" aria-label="View Image">
                                <i class="fa fa-eye"></i>
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp">
                <div class="portfolio-inner rounded">
                    <img class="img-fluid" src="<?php echo e(asset('image/Farmer3.jpg')); ?>" alt="">
                    <div class="portfolio-text">
                        <h5 class="text-white mb-3">Happy Farmer</h5>
                        <div class="d-flex">
                            <a class="btn btn-lg-square rounded-circle mx-2" href="<?php echo e(asset('image/Farmer3.jpg')); ?>" data-lightbox="farmer" aria-label="View Image">
                                <i class="fa fa-eye"></i>
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp">
                <div class="portfolio-inner rounded">
                    <img class="img-fluid" src="<?php echo e(asset('image/Farmer4.jpg')); ?>" alt="">
                    <div class="portfolio-text">
                        <h5 class="text-white mb-3">Happy Farmer</h5>
                        <div class="d-flex">
                            <a class="btn btn-lg-square rounded-circle mx-2" href="<?php echo e(asset('image/Farmer4.jpg')); ?>" data-lightbox="farmer" aria-label="View Image">
                                <i class="fa fa-eye"></i>
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp">
                <div class="portfolio-inner rounded">
                    <img class="img-fluid" src="<?php echo e(asset('image/Farmer5.jpg')); ?>" alt="">
                    <div class="portfolio-text">
                        <h5 class="text-white mb-3">Happy Farmer</h5>
                        <div class="d-flex">
                            <a class="btn btn-lg-square rounded-circle mx-2" href="<?php echo e(asset('image/Farmer5.jpg')); ?>" data-lightbox="farmer" aria-label="View Image">
                                <i class="fa fa-eye"></i>
                            </a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\viseorganic\resources\views/Gallery.blade.php ENDPATH**/ ?>