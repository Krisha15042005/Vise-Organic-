        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="<?php echo e(asset('image/carousel-1.jpg')); ?>" alt="Image">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="<?php echo e(asset('image/carousel-2.jpg')); ?>" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7">
    ...
    <div class="container">
        <div class="row g-5 align-items-end">
            ...
            <div class="col-lg-3 col-md-5 wow fadeInUp" data-wow-delay="0.1s">
                <img class="img-fluid rounded w-100" src="<?php echo e(asset('image/about.jpg')); ?>" alt="About Vise Organic" style="height: 100%; object-fit: cover;">
            </div>
...
<!-- About End -->
    ...
    <!-- Facts Start -->
    <div class="container-fluid facts my-5 py-5" data-parallax="scroll" data-image-src="<?php echo e(asset('image/carousel-1.jpg')); ?>">
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item rounded d-flex h-100">
                    <div class="service-img rounded">
                        <img class="img-fluid" src="<?php echo e(asset('image/CropRotation.jpg')); ?>" alt="Crop Rotation">
                    </div>
                    <div class="service-text rounded p-5">
                        <div class="btn-square rounded-circle mx-auto mb-3">
                            <img class="img-fluid" src="<?php echo e(asset('image/icon/plant.png')); ?>" alt="Icon">
                        </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item rounded d-flex h-100">
                    <div class="service-img rounded">
                        <img class="img-fluid" src="<?php echo e(asset('image/Compost-Production.jpg')); ?>" alt="Compost Production">
                    </div>
                    <div class="service-text rounded p-5">
                        <div class="btn-square rounded-circle mx-auto mb-3">
                            <img class="img-fluid" src="<?php echo e(asset('image/icon/fertilizer.png')); ?>" alt="Icon">
                        </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item rounded d-flex h-100">
                    <div class="service-img rounded">
                        <img class="img-fluid" src="<?php echo e(asset('image/Cover-Cropping.jpg')); ?>" alt="Cover Cropping">
                    </div>
                    <div class="service-text rounded p-5">
                        <div class="btn-square rounded-circle mx-auto mb-3">
                            <img class="img-fluid" src="<?php echo e(asset('image/icon/wheat.png')); ?>" alt="Icon">
                        </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item rounded d-flex h-100">
                    <div class="service-img rounded">
                        <img class="img-fluid" src="<?php echo e(asset('image/Pest-Management.jpg')); ?>" alt="Pest Management">
                    </div>
                    <div class="service-text rounded p-5">
                        <div class="btn-square rounded-circle mx-auto mb-3">
                            <img class="img-fluid" src="<?php echo e(asset('image/icon/sanitizer.png')); ?>" alt="Icon">
                        </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item rounded d-flex h-100">
                    <div class="service-img rounded">
                        <img class="img-fluid" src="<?php echo e(asset('image/Seed.jpg')); ?>" alt="Seed Saving">
                    </div>
                    <div class="service-text rounded p-5">
                        <div class="btn-square rounded-circle mx-auto mb-3">
                            <img class="img-fluid" src="<?php echo e(asset('image/icon/growing-seed.png')); ?>" alt="Icon">
                        </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item rounded d-flex h-100">
                    <div class="service-img rounded">
                        <img class="img-fluid" src="<?php echo e(asset('image/Mechanization.jpg')); ?>" alt="Mechanization">
                    </div>
                    <div class="service-text rounded p-5">
                        <div class="btn-square rounded-circle mx-auto mb-3">
                            <img class="img-fluid" src="<?php echo e(asset('image/icon/tractor.png')); ?>" alt="Icon">
                        </div>
...
<!-- Service End -->
    ...
    <!-- Quote Start -->
<div class="container-fluid quote my-5 py-5" data-parallax="scroll" data-image-src="<?php echo e(asset('image/carousel-2.jpg')); ?>">
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-lg-7">
            ...
            <div class="row g-4 portfolio-container">
                <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.1s">
                    <div class="portfolio-inner rounded">
                        <img class="img-fluid" src="<?php echo e(asset('image/PSB-Multiplier.jpg')); ?>" alt="PSB-Multiplier">
                        <div class="portfolio-text">
                            <h4 class="text-white mb-4">PSB-Multiplier</h4>
                            <div class="d-flex">
                                <a class="btn btn-lg-square rounded-circle mx-2" href="<?php echo e(asset('image/PSB-Multiplier.jpg')); ?>" data-lightbox="portfolio" aria-label="View Image"><i class="fa fa-eye"></i></a>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.3s">
                    <div class="portfolio-inner rounded">
                        <img class="img-fluid" src="<?php echo e(asset('image/Products/Uphar.jpg')); ?>" alt="Uphar">
                        <div class="portfolio-text">
                            <h4 class="text-white mb-4">Uphar</h4>
                            <div class="d-flex">
                                <a class="btn btn-lg-square rounded-circle mx-2" href="<?php echo e(asset('image/Products/Uphar.jpg')); ?>" data-lightbox="portfolio" aria-label="View Image"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-lg-square rounded-circle mx-2" href="" aria-label="Visit Website"><i class="fa fa-link"></i></a>
                            </div>
                            <!-- Button -->
                            <a href="/Product#psb" class="btn btn-primary mt-2">View Product</a>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.5s">
                    <div class="portfolio-inner rounded">
                        <img class="img-fluid" src="<?php echo e(asset('image/Products/Poshan.jpg')); ?>" alt="Poshan">
                        <div class="portfolio-text">
                            <h4 class="text-white mb-4">Poshan</h4>
                            <div class="d-flex">
                                <a class="btn btn-lg-square rounded-circle mx-2" href="<?php echo e(asset('image/Products/Poshan.jpg')); ?>" data-lightbox="portfolio" aria-label="View Image"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-lg-square rounded-circle mx-2" href="" aria-label="Visit Website"><i class="fa fa-link"></i></a>
                            </div>
                            <!-- Button -->
                            <a href="/Product#psb" class="btn btn-primary mt-2">View Product</a>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.1s">
                    <div class="portfolio-inner rounded">
                        <img class="img-fluid" src="<?php echo e(asset('image/Products/Mycorrhiza 3000 IP.jpg')); ?>" alt="Mycorrhiza 3000 IP">
                        <div class="portfolio-text">
                            <h4 class="text-white mb-4">Mycorrhiza 3000 IP</h4>
                            <div class="d-flex">
                                <a class="btn btn-lg-square rounded-circle mx-2" href="<?php echo e(asset('image/Products/Mycorrhiza 3000 IP.jpg')); ?>" data-lightbox="portfolio" aria-label="View Image"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-lg-square rounded-circle mx-2" href="" aria-label="Visit Website"><i class="fa fa-link"></i></a>
                            </div>
                            <!-- Button -->
                            <a href="/Product#psb" class="btn btn-primary mt-2">View Product</a>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.3s">
                    <div class="portfolio-inner rounded">
                        <img class="img-fluid" src="<?php echo e(asset('image/Products/Azotobacter Liquid Based.jpg')); ?>" alt="Azotobacter Liquid Based">
                        <div class="portfolio-text">
                            <h4 class="text-white mb-4">Azotobacter Liquid Based</h4>
                            <div class="d-flex">
                                <a class="btn btn-lg-square rounded-circle mx-2" href="<?php echo e(asset('image/Products/Azotobacter Liquid Based.jpg')); ?>" data-lightbox="portfolio" aria-label="View Image"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-lg-square rounded-circle mx-2" href="" aria-label="Visit Website"><i class="fa fa-link"></i></a>
                            </div>
                            <!-- Button -->
                            <a href="/Product#psb" class="btn btn-primary mt-2  ">View Product</a>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.5s">
                    <div class="portfolio-inner rounded">
                        <img class="img-fluid" src="<?php echo e(asset('image/Products/Silk.jpg')); ?>" alt="Silk">
                        <div class="portfolio-text">
                            <h4 class="text-white mb-4">Silk</h4>
                            <div class="d-flex">
                                <a class="btn btn-lg-square rounded-circle mx-2" href="<?php echo e(asset('image/Products/Silk.jpg')); ?>" data-lightbox="portfolio" aria-label="View Image"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-lg-square rounded-circle mx-2" href="" aria-label="Visit Website"><i class="fa fa-link"></i></a>
                            </div>
                            <!-- Button -->
                            <a href="/Product#psb" class="btn btn-primary mt-2">View Product</a>
    ...
    <div class="container-xxl py-5">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <!-- Button -->
                <a href="<?php echo e(asset('pdf/Vise-Organic-Booklet.pdf')); ?>" class="btn btn-primary py-3 px-4" download>
            ...
            <div class="col-lg-6 wow fadeInUp text-center" data-wow-delay="0.3s">
                <img class="img-fluid rounded" src="<?php echo e(asset('image/booklet.png')); ?>" alt="Booklet" style="max-height: 300px;">
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\viseorganic\resources\views/index.blade.php ENDPATH**/ ?>