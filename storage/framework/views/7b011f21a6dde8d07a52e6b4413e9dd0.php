    ...
    <div class="login-container">
        ...
        <form method="POST" action="<?php echo e(route('admin.login.post')); ?>">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" name="email" value="<?php echo e(old('email', 'admin@example.com')); ?>" required>
            </div>
            <div class="mb-3">
...
<?php /**PATH C:\Users\DELL\viseorganic\resources\views/admin/login.blade.php ENDPATH**/ ?>