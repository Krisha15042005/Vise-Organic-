            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-white rounded overflow-hidden h-100">
                        <img src="<?php echo e(asset('image/RD_1.jpg')); ?>" alt="Beauveria Bassiana Research" class="img-fluid w-100 img-fixed">
                        <div class="p-4">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="bg-white rounded overflow-hidden h-100">
                        <img src="<?php echo e(asset('image/RD_2.jpg')); ?>" alt="Paecilomyces lilacinus Research" class="img-fluid w-100 img-fixed">
                        <div class="p-4">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="bg-white rounded overflow-hidden h-100">
                        <img src="<?php echo e(asset('image/RD_3.jpg')); ?>" alt="Azotobacter Research" class="img-fluid w-100 img-fixed">
                        <div class="p-4">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="bg-white rounded overflow-hidden h-100">
                        <img src="<?php echo e(asset('image/RD_4.jpg')); ?>" alt="Ground Nut Cultivation Research" class="img-fluid w-100 img-fixed">
                        <div class="p-4">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="bg-white rounded overflow-hidden h-100">
                        <img src="<?php echo e(asset('image/RD_5.jpg')); ?>" alt="Biofertilizer Research" class="img-fluid w-100 img-fixed">
                        <div class="p-4">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="bg-white rounded overflow-hidden h-100">
                        <img src="<?php echo e(asset('image/RD_6.jpg')); ?>" alt="Beauveria bassiana Mass Multiplication" class="img-fluid w-100 img-fixed">
                        <div class="p-4">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="bg-white rounded overflow-hidden h-100">
                        <img src="<?php echo e(asset('image/RD_7.jpg')); ?>" alt="Fungal Pathogens Research" class="img-fluid w-100 img-fixed">
                        <div class="p-4">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.8s">
                    <div class="bg-white rounded overflow-hidden h-100">
                        <img src="<?php echo e(asset('image/RD_8.jpg')); ?>" alt="Rhizobium Biofertilizer" class="img-fluid w-100 img-fixed">
                        <div class="p-4">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.9s">
                    <div class="bg-white rounded overflow-hidden h-100">
                        <img src="<?php echo e(asset('image/RD_9.jpg')); ?>" alt="Cellulase Enzyme Research" class="img-fluid w-100 img-fixed">
                        <div class="p-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\DELL\viseorganic\resources\views/RandD.blade.php ENDPATH**/ ?>