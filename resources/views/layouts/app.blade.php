...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        <a href="/" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h1 class="m-0"><img src="{{ asset('image/logo1.jpg') }}" alt="Logo" height="80" width="200"></h1>
        </a>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <a href="/"><img src="{{ asset('image/logo1.jpg') }}" alt="Logo" height="60" class="mb-3"></a>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="footer-post d-flex align-items-start mb-1">
                        @if($blog->image)
                            <img src="{{ asset('storage/' . $blog->image) }}" alt="{{ $blog->title }}" class="footer-post-img me-3">
                        @else
                            <img src="{{ asset('image/placeholder.jpg') }}" alt="{{ $blog->title }}" class="footer-post-img me-3">
                        @endif
                        <div><a href="/blog" class="footer-post-title">{{ Str::limit($blog->title, 50) }}</a><p class="footer-post-date">{{ $blog->created_at->format('M d - Y') }}</p></div>
                    </div>
                    @endforeach
                </div>
                <div class="col-lg-3 col-md-6">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        <a href="/" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h1 class="m-0"><img src="{{ asset('image/logo1.png') }}" alt="Logo" height="80" width="200"></h1>
        </a>
        <button type="button" class="navbar-toggler me-4" data-bs-toggle="collapse" data-bs-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
    ...
    <div class="container-fluid bg-dark text-light footer mt-5 py-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <a href="/"><img src="{{ asset('image/logo1.png') }}" alt="Logo" height="60" class="mb-3"></a>
                    <p class="footer-desc">Offering premium natural and organic products. Experience wholesome goodness for a healthier lifestyle with our trusted selections.</p>
                    <div class="d-flex gap-2 mt-3">
                        <a class="footer-social-btn" href="" aria-label="YouTube"><i class="fab fa-youtube"></i></a>
                        <a class="footer-social-btn" href="" aria-label="Instagram"><i class="fab fa-instagram"></i></a>
